...
( D | i | r | H | u | n | t | e | r )
 \_/ \_/ \_/ \_/ \_/ \_/ \_/ \_/ \_/ 
  ...
  <><>A Directory Bruteforcer <><>
   <><> By BlackDevilHackerz <><>
'''
...
parser.add_argument("--install", required=False, help="Install DirHunter on your system.", action="store_true")
...
if args.install:
    if os.getuid() != 0:
        ...
        command = "cp dh.py dh; chmod +x dh; sudo mv dh /usr/bin/"
        os.system(command)
...
print(f"\n{cyan}[{red}*{cyan}]{white} DirHunter IS CHECKING DIRECTORIES PLEASE WAIT [CTRL+C TO STOP]...")
print("\n") 
